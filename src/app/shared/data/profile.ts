...
export const profile = {
  ...
  bio: [
    ...
    "In parallel, I have been a contracted engineer on Vitality Group's global wellness platform since 2022 - used by 27M+ members across 38 markets. Before software, I led teams of up to sixty at the Georgian Revenue Service for over a decade.",
  ],
} as const;
