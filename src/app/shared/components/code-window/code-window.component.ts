 ...
 * real role/stack/location are conveyed by the accessible hero copy.
 */
@Component({
    ...
    <div class="cw-window">
      ...
      <div class="cw-body">
        ...
        <code class="cw-code">
          ...
          <span class="code-line" style="--len: 53; --delay: 1.39s">&nbsp;&nbsp;<span class="tok-prop">stack</span><span class="tok-punct">:</span>&nbsp;<span class="tok-punct">[</span><span class="tok-str">'Angular'</span><span class="tok-punct">,</span>&nbsp;<span class="tok-str">'TypeScript'</span><span class="tok-punct">,</span>&nbsp;<span class="tok-str">'Java'</span><span class="tok-punct">,</span>&nbsp;<span class="tok-str">'Spring'</span><span class="tok-punct">]</span><span class="tok-punct">,</span></span>
          <span class="code-line" style="--len: 26; --delay: 2.50s">&nbsp;&nbsp;<span class="tok-prop">location</span><span class="tok-punct">:</span>&nbsp;<span class="tok-str">'Tbilisi, GE'</span><span class="tok-punct">,</span></span>
          <span class="code-line" style="--len: 18; --delay: 3.07s">&nbsp;&nbsp;<span class="tok-prop">available</span><span class="tok-punct">:</span>&nbsp;<span class="tok-bool">true</span><span class="tok-punct">,</span></span>
          <span class="code-line" style="--len: 2; --delay: 3.48s"><span class="tok-punct">&#125;</span><span class="tok-punct">;</span></span>
        </code>
      </div>
    </div>
  `,
